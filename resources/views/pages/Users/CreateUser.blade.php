                                    ...
                                    <div class="row">
                                        <div class="col-md-6 hidden-sm hidden-xs">
                                            <ul class="breadcrumb bg-white text-left no-margin padding-t-sm">
                                                ...
                                                <li><a href="/EmployeeDetails" class="text-mg">Users List</a></li>
                                                <li class="active text-dg">Create Users</li>
                                            </ul>
                                        </div>
                                        <div class="col-md-6 col-sm-12 col-xs-12">
                                            <h5 class="text-right no-margin text-italic text-normal font-12">E.T.M.S</h5>
                                            <h1 class="text-right no-margin"><i class="fa fa-users" aria-hidden="true"></i> Create Users</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="section no-margin">
                                    <div class="section-body no-padding">
                                        <ul class="nav nav-pills padding-xs">
                                            <li class="active"><a href="/EmployeeCreate" data-toggle="pill">Create Users</a></li>
                                            <li><a href="/EmployeeDetails">Users List</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="Activity" class="tab-pane fade in active">
									<div class="section">
										...
										<div class="col-sm-12" style="color:green; margin-top:10px; margin-bottom:10px;" >
                                            ...
                                            <form class="form-horizontal validate-form" action="/AddUsers" method="post" enctype="multipart/form-data" >
											@csrf
