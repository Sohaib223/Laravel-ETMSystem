										...
										<div class="row">
											<div class="col-md-6 hidden-sm hidden-xs">
												<ul class="breadcrumb bg-white text-left no-margin padding-t-sm">
													...
													<li class="active text-dg"> Edit Expences</li>
												</ul>
											</div>
											<div class="col-md-6 col-sm-12 col-xs-12">
												<h5 class="text-right no-margin text-italic text-normal font-12">E.T.M.S</h5>
												<h1 class="text-right no-margin"><i class="fa fa-users" aria-hidden="true"></i> Edit Expences</h1>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="section no-margin">
										<div class="section-body no-padding">
											<ul class="nav nav-pills padding-xs">
												<li class="active"><a href="#" data-toggle="pill"> Edit Expences</a></li>
							...
							<div class="tab-content">
								<div id="Activity" class="tab-pane fade in active">
									...
									<div class="col-sm-12" style="color:green; margin-top:10px; margin-bottom:10px;" >
										...
										<div class="section-body">
											<form class="form-horizontal validate-form" action="/UpdateExpences/{{$expences->id}}" method="POST">
											@csrf					
											<div class="form-group">
												<label for="inputphone" class="col-sm-2 control-label">title :</label>
													<div class="col-sm-10">
														...
														@endif
											  			<input class="date form-control" type="text" value="{{$expences->title}}" name="title" id="Task" placeholder="Please enter title" >
													</div>
											</div>
											<div class="form-group">
												<label for="inputphone" class="col-sm-2 control-label">Description :</label>
													<div class="col-sm-10">
														...
														@endif
											  			<input class="date form-control" type="text" value="{{$expences->decs}}" name="description" id="Task" placeholder="Please enter description" >
													</div>
											</div>
											<div class="form-group">
												<label for="inputphone" class="col-sm-2 control-label">Amount :</label>
													<div class="col-sm-10">
														...
														@endif
														  <input type="number" name="amount" placeholder="Please enter amount" value="{{$expences->amount}}" class="form-control margin-b-sm">
													</div>
											</div>
												<div class="form-group">
