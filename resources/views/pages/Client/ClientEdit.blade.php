											...
											<div class="modal-dialog modal-lg" role="document">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title">Edite Client Details</h4>
													</div>
                                                    <div class="modal-body">
                                                        <form action="/UpdateClient/{{$clients->id}}" method="post">
                                                            @csrf
                                                            <div class="form-group">
                                                                <label for="recipient-name1" class="form-control-label">Name:</label>
                                                                <input type="text" name="name" value="{{$clients->Name}}" class="form-control" id="recipient-name1">
                                                            </div>
                                                            <div class="form-group">
                                                                    <label for="recipient-name1" class="form-control-label">Address:</label>
                                                                    <input type="text" name="address" value="{{$clients->Address}}" class="form-control" id="recipient-name1">
                                                                </div>
                                                            <div class="form-group">
                                                                <label for="recipient-name1" class="form-control-label">Phone Number:</label>
                                                                <input type="text" name="pcell" value="{{$clients->Phonenumber}}" class="form-control" id="recipient-name1">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="recipient-name1" class="form-control-label">Company Name:</label>
                                                                <input type="text" name="cname" value="{{$clients->CompanyName}}" class="form-control" id="recipient-name1">
                                                            </div>
