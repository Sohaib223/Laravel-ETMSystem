							...
							<div class="tab-content">
								<div id="Activity" class="tab-pane fade in active">
									...
									<div class="col-sm-12" style="color:green; margin-top:10px; margin-bottom:10px;" >
										...
										<div class="section-body">
											<form class="form-horizontal validate-form" action="{{url('/AssignCDuties') }}" method="POST">
	...
	$('.client_id').change(function(){
		...
		$.ajax({
			...
			success : function (response) {
				...
				$('#CCell').val(response.Phonenumber);
				$('#CAdress').val(response.Address);
			}
		});
	});
});
