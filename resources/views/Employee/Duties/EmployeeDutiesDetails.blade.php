															...
															<thead>
																...
																<tr>
																		...
																		<td>
																			...
																			<a href="Update-Dueties-Status/{{ $row->id }}" class="btn btn-default text-mg btn-xs margin-b-xs" title="Edit"><i class="fa fa-pencil fa-lg"></i></a>
																			<a href="DeleteDuties/{{ $row->id }}" onclick="return myFunction();" class="btn btn-default text-mg btn-xs margin-b-xs delete" title="Delete"><i class="fa fa-trash-o fa-lg"></i></a>
