							...
							<div class="tab-content">
								<div id="Activity" class="tab-pane fade in active">
									...
									<div class="col-sm-12" style="color:green; margin-top:10px; margin-bottom:10px;" >
										...
										<div class="section-body">
											<form class="form-horizontal validate-form" action="/CreateLeave" method="POST">
											@csrf
											<div class="form-group">
												<label for="skill" class="col-sm-2 control-label">Employee Name :</label>
												    <div class="col-sm-10">
													<input type="text" name="employeename" value="{{Auth::user()->name}}" class="form-control" readonly >
													<input type="text" name="employeeid" value="{{Auth::user()->id}}" class="form-control" readonly >
												</div>
											</div>
                                            <div class="form-group">
												<label for="skill" class="col-sm-2 control-label">Reason Of Leave :</label>
												    <div class="col-sm-10">
                                            ...
                                            <div class="form-group">
												<label for="skill" class="col-sm-2 control-label">From - To :</label>
												    <div class="col-sm-10">
