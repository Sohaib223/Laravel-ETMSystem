...
<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('assets/lib/lobipanel/dist/css/lobipanel.min.css')}}">
		...
		<!-- Clock Picker -->
		<link rel="stylesheet" type="text/css" href="{{asset('assets/lib/clockpicker/dist/bootstrap-clockpicker.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{asset('assets/lib/clockpicker/dist/jquery-clockpicker.min.css')}}">
		...
		<link rel="stylesheet" type="text/css" href="{{asset('assets/lib/summernote/dist/summernote.css')}}">
...
<!-- Header -->
		...
		<!-- Custom javascript -->
		<script type="text/javascript" src="{{asset('assets/lib/lobipanel/dist/js/lobipanel.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/lib/jquery-ui/jquery-ui.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/dist/js/lobi-panel.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/lib/bootstrap/dist/js/bootstrap.min.js')}}"></script>
		...
		<script type="text/javascript" src="{{asset('assets/lib/summernote/dist/summernote.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/dist/js/mail.min.js')}}"></script>
	</body>
